...
abstract class Command extends Component
{
    ...
    public function calcTime($time)
    {
        ...
        $minute = floor(($time - ($month * $monthLong) - ($week * $weekLong) - ($day * $dayLong) - ($hour * $hourLong)) / $minuteLong);
        ...
        $returnTime .= $returnTime == '' ? ($minute > 0 ? $minute . Yii::t('app_bot', 'minute') : Yii::t('app_2', 'Less than a minute')) : '';
