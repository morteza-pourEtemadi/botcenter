...
class AboutCommand extends CommandLocal
{
    ...
    {
        $message = Yii::t('app_1', 'Ultimate Developers is a programming team to make your world online! Making websites, Telegram Bots and all other web services are in our expertise');
